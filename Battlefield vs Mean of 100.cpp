...
int main()
{
    ...
    correct_decision = 0;
    overall_obs = 0;
    int num_of_incorrect_systems = 0;
    ...
    for (int l = 0; l < NumMacro; l++) {   
        ...
        final_cd = 1;  
        n0_counter = 0;
        int num_of_incorrect_decisions = 0;    
        ...
        for (int i = 0; i < NumSys; i++) {
            ...
            // if (incorrectness > 0){
            //     printf("s %d incorrectness: %d\n", i+1, incorrectness);
            // }

            num_of_incorrect_decisions += incorrectness;
        ...
        printf("Macro %d incorrectness: %d\n", l+1, num_of_incorrect_decisions);

        overall_obs += total_obs;   //각 iter마다 했던 obs 갯수를 다 더함
        num_of_incorrect_systems += num_of_incorrect_decisions;
    ...
    printf("Incorrect systems: %d\n", num_of_incorrect_systems / NumMacro);

...
//        printf("%.f\t%.f\t%.f\t%.f\t%.f\t%.f\n", s10[0][0], s11[0][0], s12[0][0],s20[0][0], s21[0][0], s22[0][0]);
        ...
        if(DOMBERF == 1){
            ...
            // first pass
            T_index[0][0][0] = 0; T_index[0][1][0] = 0; T_index[0][2][0] = 1; T_index[0][3][0] = 1; 
            T_index[0][0][1] = 0; T_index[0][1][1] = 0; T_index[0][2][1] = 1; T_index[0][3][1] = 1; 
            // T_index[0][4][0] = 1; T_index[0][5][0] = 1; T_index[0][6][0] = 1; T_index[0][7][0] = 1;

            // // second pass
            T_index[1][0][0] = 1; T_index[1][1][0] = 1; T_index[1][2][0] = 0; T_index[1][3][0] = 0;
            T_index[1][0][1] = 1; T_index[1][1][1] = 1; T_index[1][2][1] = 0; T_index[1][3][1] = 0;
